...
// date: 2009/12/07 18:07:50
  ...
  'cache_dir' => '/var/wviola/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/wviola/apps/frontend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/wviola/cache/frontend/prod/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/var/wviola/apps/frontend/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/wviola/cache/frontend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/wviola/apps/frontend/template',
)));
