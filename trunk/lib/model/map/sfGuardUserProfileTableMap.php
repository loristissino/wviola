...
class sfGuardUserProfileTableMap extends TableMap {
    ...
    $this->addRelation('BinderRelatedByUserId', 'Binder', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), 'CASCADE', 'CASCADE');
    $this->addRelation('BinderRelatedByTaggerUserId', 'Binder', RelationMap::ONE_TO_MANY, array('user_id' => 'tagger_user_id', ), 'CASCADE', 'CASCADE');
    ...
    $this->addRelation('Source', 'Source', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
