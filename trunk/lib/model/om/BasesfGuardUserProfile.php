...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	 ...
	 */
	public function getAssetsJoinAssetType($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserProfilePeer::DATABASE_NAME);
		}
		...
		if ($this->collAssets === null) {
			if ($this->isNew()) {
				...
				$this->collAssets = AssetPeer::doSelectJoinAssetType($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
