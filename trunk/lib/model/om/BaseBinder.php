...
abstract class BaseBinder extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_open = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->archive_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			...
			return $startcol + 9; // 9 = BinderPeer::NUM_COLUMNS - BinderPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setIsOpen($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setArchiveId($arr[$keys[6]]);
