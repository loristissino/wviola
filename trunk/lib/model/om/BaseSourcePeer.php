...
abstract class BaseSourcePeer {
	...
	const USER_ID = 'source.USER_ID';

	/** the column name for the RELATIVE_PATH field */
	const RELATIVE_PATH = 'source.RELATIVE_PATH';

	/** the column name for the BASENAME field */
	...
	/** the column name for the TASK_LOG_EVENT_ID field */
	const TASK_LOG_EVENT_ID = 'source.TASK_LOG_EVENT_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'RelativePath', 'Basename', 'Status', 'Inode', 'TaskLogEventId', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'relativePath', 'basename', 'status', 'inode', 'taskLogEventId', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::RELATIVE_PATH, self::BASENAME, self::STATUS, self::INODE, self::TASK_LOG_EVENT_ID, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'relative_path', 'basename', 'status', 'inode', 'task_log_event_id', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'RelativePath' => 2, 'Basename' => 3, 'Status' => 4, 'Inode' => 5, 'TaskLogEventId' => 6, 'CreatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'relativePath' => 2, 'basename' => 3, 'status' => 4, 'inode' => 5, 'taskLogEventId' => 6, 'createdAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::RELATIVE_PATH => 2, self::BASENAME => 3, self::STATUS => 4, self::INODE => 5, self::TASK_LOG_EVENT_ID => 6, self::CREATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'relative_path' => 2, 'basename' => 3, 'status' => 4, 'inode' => 5, 'task_log_event_id' => 6, 'created_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SourcePeer::USER_ID);
		$criteria->addSelectColumn(SourcePeer::RELATIVE_PATH);
		$criteria->addSelectColumn(SourcePeer::BASENAME);
		$criteria->addSelectColumn(SourcePeer::STATUS);
		$criteria->addSelectColumn(SourcePeer::INODE);
		$criteria->addSelectColumn(SourcePeer::TASK_LOG_EVENT_ID);
		$criteria->addSelectColumn(SourcePeer::CREATED_AT);
	}
	 ...
	 */
	public static function addInstanceToPool(Source $obj, $key = null)
	{
	...
	public static function doCountJoinsfGuardUserProfile(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SourcePeer::USER_ID, sfGuardUserProfilePeer::USER_ID, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related TaskLogEvent table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinTaskLogEvent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Source objects pre-filled with their sfGuardUserProfile objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinsfGuardUserProfile(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Source) to $obj2 (sfGuardUserProfile)
				$obj2->addSource($obj1);
	...
	/**
	 * Selects a collection of Source objects pre-filled with their TaskLogEvent objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Source objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinTaskLogEvent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SourcePeer::addSelectColumns($criteria);
		$startcol2 = (SourcePeer::NUM_COLUMNS - SourcePeer::NUM_LAZY_LOAD_COLUMNS);

		sfGuardUserProfilePeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (sfGuardUserProfilePeer::NUM_COLUMNS - sfGuardUserProfilePeer::NUM_LAZY_LOAD_COLUMNS);

		TaskLogEventPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (TaskLogEventPeer::NUM_COLUMNS - TaskLogEventPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Source) to the collection in $obj2 (sfGuardUserProfile)
				$obj2->addSource($obj1);
			} // if joined row not null

			// Add objects for joined TaskLogEvent rows

			$key3 = TaskLogEventPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = TaskLogEventPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					TaskLogEventPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (Source) to the collection in $obj3 (TaskLogEvent)
				$obj3->addSource($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptTaskLogEvent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Source objects pre-filled with all related objects except sfGuardUserProfile.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptsfGuardUserProfile(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		TaskLogEventPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (TaskLogEventPeer::NUM_COLUMNS - TaskLogEventPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = SourcePeer::getInstanceFromPool($key1))) {
				...
				$key2 = TaskLogEventPeer::getPrimaryKeyHashFromRow($row, $startcol2);
				if ($key2 !== null) {
					$obj2 = TaskLogEventPeer::getInstanceFromPool($key2);
					if (!$obj2) {
				...
				// Add the $obj1 (Source) to the collection in $obj2 (TaskLogEvent)
				$obj2->addSource($obj1);
	...
	/**
	 * Selects a collection of Source objects pre-filled with all related objects except TaskLogEvent.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptTaskLogEvent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	{
		return $withPrefix ? SourcePeer::CLASS_DEFAULT : SourcePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Source or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSourcePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSourcePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSourcePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSourcePeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Source or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSourcePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSourcePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSourcePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSourcePeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the source table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Source or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Source) {
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseSourcePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
