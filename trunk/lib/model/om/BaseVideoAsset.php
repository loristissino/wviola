...
abstract class BaseVideoAsset extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the highquality_video_pixelformat field.
	 * @var        string
	 */
	protected $highquality_video_pixelformat;
	...
	/**
	 * The value for the lowquality_video_pixelformat field.
	 * @var        string
	 */
	protected $lowquality_video_pixelformat;
	...
	/**
	 * Get the [highquality_video_pixelformat] column value.
	 * 
	 * @return     string
	 */
	public function getHighqualityVideoPixelformat()
	{
		return $this->highquality_video_pixelformat;
	}
	...
	/**
	 * Get the [lowquality_video_pixelformat] column value.
	 * 
	 * @return     string
	 */
	public function getLowqualityVideoPixelformat()
	{
		return $this->lowquality_video_pixelformat;
	}
	...
	/**
	 * Set the value of [highquality_video_pixelformat] column.
	 * 
	 * @param      string $v new value
	 * @return     VideoAsset The current object (for fluent API support)
	 */
	public function setHighqualityVideoPixelformat($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->highquality_video_pixelformat !== $v) {
			$this->highquality_video_pixelformat = $v;
			$this->modifiedColumns[] = VideoAssetPeer::HIGHQUALITY_VIDEO_PIXELFORMAT;
		}

		return $this;
	} // setHighqualityVideoPixelformat()
	...
	/**
	 * Set the value of [lowquality_video_pixelformat] column.
	 * 
	 * @param      string $v new value
	 * @return     VideoAsset The current object (for fluent API support)
	 */
	public function setLowqualityVideoPixelformat($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->lowquality_video_pixelformat !== $v) {
			$this->lowquality_video_pixelformat = $v;
			$this->modifiedColumns[] = VideoAssetPeer::LOWQUALITY_VIDEO_PIXELFORMAT;
		}

		return $this;
	} // setLowqualityVideoPixelformat()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->highquality_video_pixelformat = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->highquality_audio_codec = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->highquality_frame_rate = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->highquality_aspect_ratio = ($row[$startcol + 8] !== null) ? (double) $row[$startcol + 8] : null;
			$this->lowquality_width = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->lowquality_height = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->lowquality_video_codec = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->lowquality_video_pixelformat = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->lowquality_audio_codec = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->lowquality_frame_rate = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->resetModified();
			...
			return $startcol + 15; // 15 = VideoAssetPeer::NUM_COLUMNS - VideoAssetPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				return $this->getHighqualityVideoPixelformat();
				break;
			case 6:
			...
			case 11:
				...
				break;
			case 12:
				return $this->getLowqualityVideoPixelformat();
				break;
			case 13:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getHighqualityVideoPixelformat(),
			$keys[6] => $this->getHighqualityAudioCodec(),
			$keys[7] => $this->getHighqualityFrameRate(),
			$keys[8] => $this->getHighqualityAspectRatio(),
			$keys[9] => $this->getLowqualityWidth(),
			$keys[10] => $this->getLowqualityHeight(),
			$keys[11] => $this->getLowqualityVideoCodec(),
			$keys[12] => $this->getLowqualityVideoPixelformat(),
			$keys[13] => $this->getLowqualityAudioCodec(),
			$keys[14] => $this->getLowqualityFrameRate(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				$this->setHighqualityVideoPixelformat($value);
				break;
			case 6:
			...
			case 11:
				...
				break;
			case 12:
				$this->setLowqualityVideoPixelformat($value);
				break;
			case 13:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setHighqualityVideoPixelformat($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setHighqualityAudioCodec($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setHighqualityFrameRate($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setHighqualityAspectRatio($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setLowqualityWidth($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setLowqualityHeight($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setLowqualityVideoCodec($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setLowqualityVideoPixelformat($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setLowqualityAudioCodec($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setLowqualityFrameRate($arr[$keys[14]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VideoAssetPeer::HIGHQUALITY_VIDEO_PIXELFORMAT)) $criteria->add(VideoAssetPeer::HIGHQUALITY_VIDEO_PIXELFORMAT, $this->highquality_video_pixelformat);
		...
		if ($this->isColumnModified(VideoAssetPeer::LOWQUALITY_VIDEO_PIXELFORMAT)) $criteria->add(VideoAssetPeer::LOWQUALITY_VIDEO_PIXELFORMAT, $this->lowquality_video_pixelformat);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setHighqualityVideoPixelformat($this->highquality_video_pixelformat);
		...
		$copyObj->setLowqualityVideoPixelformat($this->lowquality_video_pixelformat);
