...
abstract class BaseArchive extends BaseObject  implements Persistent {
	 ...
	 * actually need in Archive.
	 */
	public function getBindersJoinsfGuardUserProfile($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArchivePeer::DATABASE_NAME);
		}
		...
		if ($this->collBinders === null) {
			if ($this->isNew()) {
				...
				$this->collBinders = BinderPeer::doSelectJoinsfGuardUserProfile($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
