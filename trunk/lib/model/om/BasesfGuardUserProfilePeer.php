...
abstract class BasesfGuardUserProfilePeer {
	...
	{
		// invalidate objects in AssetPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Asset objects
			$criteria = new Criteria(AssetPeer::DATABASE_NAME);
			
			$criteria->add(AssetPeer::USER_ID, $obj->getUserId());
			$affectedRows += AssetPeer::doDelete($criteria, $con);
