...
abstract class BasesfGuardUserPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in AccessLogPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related AccessLog objects
			$criteria = new Criteria(AccessLogPeer::DATABASE_NAME);
			
			$criteria->add(AccessLogPeer::USER_ID, $obj->getId());
			$affectedRows += AccessLogPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
