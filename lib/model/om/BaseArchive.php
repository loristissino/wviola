...
abstract class BaseArchive extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the archive_type field.
	 * @var        int
	 */
	...
	/**
	 * Get the [archive_type] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [archive_type] column.
	 * 
	 * @param      int $v new value
	 * @return     Archive The current object (for fluent API support)
	 */
	public function setArchiveType($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->archive_type !== $v) {
			$this->archive_type = $v;
			$this->modifiedColumns[] = ArchivePeer::ARCHIVE_TYPE;
		}
	...
	public function setPosition($v)
	{
		...
		if ($this->position !== $v) {
			$this->position = $v;
			$this->modifiedColumns[] = ArchivePeer::POSITION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->archive_type = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->position = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->created_at = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->burned_at = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->user_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->md5sum = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = ArchivePeer::NUM_COLUMNS - ArchivePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getSlug(),
			$keys[2] => $this->getArchiveType(),
			$keys[3] => $this->getPosition(),
			$keys[4] => $this->getCreatedAt(),
			$keys[5] => $this->getBurnedAt(),
			$keys[6] => $this->getUserId(),
			$keys[7] => $this->getMd5sum(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setArchiveType($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setPosition($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setCreatedAt($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setBurnedAt($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setUserId($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setMd5sum($arr[$keys[7]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArchivePeer::ARCHIVE_TYPE)) $criteria->add(ArchivePeer::ARCHIVE_TYPE, $this->archive_type);
		if ($this->isColumnModified(ArchivePeer::POSITION)) $criteria->add(ArchivePeer::POSITION, $this->position);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setArchiveType($this->archive_type);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Archive has previously been saved, it will retrieve
	 * related Binders from storage. If this Archive is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collBinders === null) {
			if ($this->isNew()) {
			   $this->collBinders = array();
				...
				$criteria->add(BinderPeer::ARCHIVE_ID, $this->id);
	 ...
	 * actually need in Archive.
	 */
	public function getBindersJoinsfGuardUserProfileRelatedByUserId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArchivePeer::DATABASE_NAME);
		}
		...
		if ($this->collBinders === null) {
			if ($this->isNew()) {
				...
				$this->collBinders = BinderPeer::doSelectJoinsfGuardUserProfileRelatedByUserId($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in Archive.
	 */
	public function getBindersJoinsfGuardUserProfileRelatedByTaggerUserId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArchivePeer::DATABASE_NAME);
		}
		...
		if ($this->collBinders === null) {
			if ($this->isNew()) {
				...
				$this->collBinders = BinderPeer::doSelectJoinsfGuardUserProfileRelatedByTaggerUserId($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
