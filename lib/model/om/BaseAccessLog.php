...
abstract class BaseAccessLog extends BaseObject  implements Persistent {
	...
	public function setAssetId($v)
	{
		...
		if ($this->asset_id !== $v) {
			$this->asset_id = $v;
			$this->modifiedColumns[] = AccessLogPeer::ASSET_ID;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AccessLogPeer::ASSET_ID)) $criteria->add(AccessLogPeer::ASSET_ID, $this->asset_id);
	...
	public function getsfGuardUserProfile(PropelPDO $con = null)
	{
		if ($this->asfGuardUserProfile === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserProfile->addAccessLogs($this);
			 */
		}
