...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'FirstName', 'LastName', 'ImportedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'firstName', 'lastName', 'importedAt', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::FIRST_NAME, self::LAST_NAME, self::IMPORTED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'first_name', 'last_name', 'imported_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'FirstName' => 1, 'LastName' => 2, 'ImportedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'firstName' => 1, 'lastName' => 2, 'importedAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::FIRST_NAME => 1, self::LAST_NAME => 2, self::IMPORTED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'first_name' => 1, 'last_name' => 2, 'imported_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(BinderUserPeer::USER_ID, $obj->getUserId());
