...
abstract class BasesfGuardUserProfilePeer {
	...
	const IMPORTED_AT = 'sf_guard_user_profile.IMPORTED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'FirstName', 'LastName', 'Email', 'ImportedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'firstName', 'lastName', 'email', 'importedAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::FIRST_NAME, self::LAST_NAME, self::EMAIL, self::IMPORTED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'first_name', 'last_name', 'email', 'imported_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'FirstName' => 1, 'LastName' => 2, 'Email' => 3, 'ImportedAt' => 4, 'UpdatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'firstName' => 1, 'lastName' => 2, 'email' => 3, 'importedAt' => 4, 'updatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::FIRST_NAME => 1, self::LAST_NAME => 2, self::EMAIL => 3, self::IMPORTED_AT => 4, self::UPDATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'first_name' => 1, 'last_name' => 2, 'email' => 3, 'imported_at' => 4, 'updated_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::IMPORTED_AT);
	...
	{
		// invalidate objects in BinderPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		BinderPeer::clearInstancePool();

		// invalidate objects in BinderPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		BinderPeer::clearInstancePool();

		// invalidate objects in ArchivePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		ArchivePeer::clearInstancePool();

		// invalidate objects in SourcePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Binder objects
			$criteria = new Criteria(BinderPeer::DATABASE_NAME);
			
			$criteria->add(BinderPeer::USER_ID, $obj->getUserId());
			$affectedRows += BinderPeer::doDelete($criteria, $con);

			// delete related Binder objects
			$criteria = new Criteria(BinderPeer::DATABASE_NAME);
			
			$criteria->add(BinderPeer::TAGGER_USER_ID, $obj->getUserId());
			$affectedRows += BinderPeer::doDelete($criteria, $con);

			// delete related Archive objects
			$criteria = new Criteria(ArchivePeer::DATABASE_NAME);
			
			$criteria->add(ArchivePeer::USER_ID, $obj->getUserId());
			$affectedRows += ArchivePeer::doDelete($criteria, $con);

			// delete related Source objects
			$criteria = new Criteria(SourcePeer::DATABASE_NAME);
			
			$criteria->add(SourcePeer::USER_ID, $obj->getUserId());
			$affectedRows += SourcePeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
