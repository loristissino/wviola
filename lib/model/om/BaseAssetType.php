...
/**
 * Base class that represents a row from the 'asset_type' table.
 *
 * 
 *
...
abstract class BaseAssetType extends BaseObject  implements Persistent {
	 ...
	 * @return     AssetType The current object (for fluent API support)
	 */
	...
	public function setAttributes($v)
	{
		...
		if ($this->attributes !== $v) {
			$this->attributes = $v;
			$this->modifiedColumns[] = AssetTypePeer::ATTRIBUTES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->attributes = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = AssetTypePeer::NUM_COLUMNS - AssetTypePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setAttributes($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AssetTypePeer::ATTRIBUTES)) $criteria->add(AssetTypePeer::ATTRIBUTES, $this->attributes);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AssetType (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAttributes($this->attributes);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AssetType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this AssetType has previously been saved, it will retrieve
	 * related Assets from storage. If this AssetType is new, it will return
		...
		if ($this->collAssets === null) {
			if ($this->isNew()) {
			   $this->collAssets = array();
				...
				$criteria->add(AssetPeer::ASSET_TYPE_ID, $this->id);
	 ...
	 * Otherwise if this AssetType is new, it will return
	 * an empty collection; or if this AssetType has previously
	 * been saved, it will retrieve related Assets from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AssetType.
	 */
