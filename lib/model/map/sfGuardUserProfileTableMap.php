...
class sfGuardUserProfileTableMap extends TableMap {
    ...
    $this->addRelation('Binder', 'Binder', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), 'CASCADE', 'CASCADE');
    $this->addRelation('BinderUser', 'BinderUser', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), 'CASCADE', 'CASCADE');
