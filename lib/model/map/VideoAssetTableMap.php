...
class VideoAssetTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('HIGHQUALITY_VIDEO_PIXELFORMAT', 'HighqualityVideoPixelformat', 'VARCHAR', false, 20, null);
		...
		$this->addColumn('LOWQUALITY_VIDEO_PIXELFORMAT', 'LowqualityVideoPixelformat', 'VARCHAR', false, 20, null);
