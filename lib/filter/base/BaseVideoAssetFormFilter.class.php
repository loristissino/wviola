...
abstract class BaseVideoAssetFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'highquality_video_pixelformat' => new sfWidgetFormFilterInput(),
      ...
      'lowquality_video_pixelformat'  => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'highquality_video_pixelformat' => new sfValidatorPass(array('required' => false)),
      ...
      'lowquality_video_pixelformat'  => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'highquality_video_pixelformat' => 'Text',
      ...
      'lowquality_video_pixelformat'  => 'Text',
